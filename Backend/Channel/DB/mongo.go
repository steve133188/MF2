...
func MongoConnect() {
	...
	if counts == 0 {
		...
		res, err := customers.InsertOne(context.TODO(), bson.M{"id": id.String(), "name": "whatsappstella", "channel_id": "5e4367dd3c660d5d5e541176", "server": " https://35.198.244.95:9099", "server_auth": Util.GoDotEnvVariable("Stella_token")})
		if err != nil {
			fmt.Println(err)
		}
